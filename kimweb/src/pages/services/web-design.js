                                            ...
                                            <div className="row clearfix">
                                                ...
                                                <div className="graph-column col-md-6 col-sm-6 col-xs-12">
                                                    <div className="inner-column">
                                                        ...
                                                        <div className="services-text">Our website are eye attracting to visitors, Our teams blends all company details in modules that are simple, precise and attractive.</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="graph-column col-md-6 col-sm-6 col-xs-12">
                                                    <div className="inner-column">
                                                        ...
                                                        <div className="services-text">A client's company data is kept secure with the latest tools and technologies. Never worry about scams and any other cyber attacks.</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="graph-column col-md-6 col-sm-6 col-xs-12">
                                                    <div className="inner-column">
                                                        ...
                                                        <div className="services-text">All our plans are price friendly to everyone and encompasses all features. From as low as UGX 350,000 ($100) with all technologies encompassed.</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="graph-column col-md-6 col-sm-6 col-xs-12">
                                                    <div className="inner-column">
                                                        ...
                                                        <div className="services-text">Websites developed by Kim Digitary are responsive to all web browsers and devices ranging from smart phones, tablets and computers.</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="graph-column col-md-6 col-sm-6 col-xs-12">
                                                    <div className="inner-column">
                                                        ...
                                                        <div className="services-text">Our team is available to respond to any inquiries from a client instantly and effectively.
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="graph-column col-md-6 col-sm-6 col-xs-12">
                                                    <div className="inner-column">
                                                        <h4>TRUST</h4>
                                                        <div className="services-text">What we promise to offer is what is provide to our clients. IN summary what we promise, is what we give,
                                                        </div>
                                                    </div>
                                                </div>
